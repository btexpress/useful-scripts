...
[[ $- = *i* ]] && source ~/git-repos/liquidprompt/liquidprompt
#
# Aliases
#
# Aliases for colorization
...
# Think about removing the stuff below
export AWS_KEYS=$HOME/Downloads/aws_keys
#
export AWS_PROFILE=etsintegration
#
export ANSIBLE_HOSTS=/home/wtooles/git-repos/ansible-bt/ec2.py
#export ANSIBLE_HOSTS=~/git-repos/ansible-bt/ec2.py
